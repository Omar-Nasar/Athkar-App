        ...
        ZI1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ss1 < 25){
                    ...
                    Toast.makeText(getApplicationContext(), "عفواً لا يمكنك تكبير النص أكثر", Toast.LENGTH_SHORT).show();
                }
                tv1.setTextSize(ss1);
            }
        });
        ...
        ZO1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ss1 > 15){
                    ...
                    Toast.makeText(getApplicationContext(), "عفواً لا يمكنك تصغير النص أكثر", Toast.LENGTH_SHORT).show();
                }
                tv1.setTextSize(ss1);
            }
        });
